...
public class TicTacToe implements ActionListener{
	...
	TicTacToe(){
		...
		title_panel.setBounds(0,0,1000,200);
		...
		frame.add(title_panel,BorderLayout.NORTH);//adds title
		frame.add(button_panel);//adds buttons
